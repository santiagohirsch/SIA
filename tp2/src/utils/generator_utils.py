...
BEST_FIRST_SELECTION_METHOD = 'boltzmann'
BEST_SECOND_SELECTION_METHOD = 'boltzmann'
BEST_REPLACEMENT_METHOD = 'young'
BEST_REPLACEMENT_FIRST_SELECTION_METHOD = 'ranking'
BEST_REPLACEMENT_SECOND_SELECTION_METHOD = 'elite'