...
from src.utils.generator_utils import BEST_CROSSING_METHOD, BEST_MUTATION_METHOD, BEST_FIRST_SELECTION_METHOD, BEST_SECOND_SELECTION_METHOD, BEST_MUTATION_RATE, DEFAULT_A_VALUE, DEFAULT_INDIVIDUALS, DEFAULT_CUTOFF_METHOD, DEFAULT_CUTOFF_VALUE, DEFAULT_CUTOFF_GENERATIONS, DEFAULT_B_VALUE, DEFAULT_ATTRIBUTE_SETS
import csv
